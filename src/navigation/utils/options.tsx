...
import { BarberBottomTabParamList, ClientBottomTabParamList } from "../types/barberTypes";

export const clientBottomTabOptions = ({
  route,
}: {
  route: RouteProp<ClientBottomTabParamList, keyof ClientBottomTabParamList>;
}) => {
