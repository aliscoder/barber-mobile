...
import { usePushNotification, useToast } from "@hooks";
...
const ReviewModal: React.FC<Props> = ({ isOpen, rater, barberId, onClose }) => {
  ...
  return (
    <Modal isSheet isOpen={isOpen} onClose={onClose}>
      <Flex p={3} w="full" background="#FFFFFF" borderTopRightRadius={15} borderTopLeftRadius={15}>
