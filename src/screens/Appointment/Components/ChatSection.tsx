import { Avatar, Input, Row, Touch } from "@components";
import { AntDesign } from "@expo/vector-icons";
import { useAuth, usePushNotification } from "@hooks";
...
const ChatSection = ({ appointment }: { appointment: AppointmentInterface }) => {
  ...
  useEffect(() => {
    console.log("ChatSection runned");
    ...
    return (
      ...
      >
        <Row space={4}>
          ...
          <View
            width="56"
            background={SENDER_ID === user._id ? "green.500" : "gray.500"}
            borderRadius={5}
            py={1}
            px={2}
          >
